...
public class SplashScreenActivity extends AwesomeSplash {
    ...
    public void initSplash(ConfigSplash configSplash) {
        ...
        //Customize Title
        configSplash.setTitleSplash("PEOPLE TRACKING "); //change your app name here USING GSM/GPS
    ...
    public void animationsFinished() {
        ...
        startActivity(i);
        Toast.makeText(SplashScreenActivity.this, "Go to MainActivity now!!", Toast.LENGTH_SHORT).show();
